...
test('approved-git-books.json matches schema', t => {
  const listData = fs.readFileSync(gitBooksListPath, { encoding: 'utf8' })
  const list = JSON.parse(listData)
  const schemaData = fs.readFileSync(gitSchemaPath, { encoding: 'utf8' })
